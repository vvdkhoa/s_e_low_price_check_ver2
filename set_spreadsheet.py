...
# Need share sheet for: ebaygetprice2@ebaygetprices2.iam.gserviceaccount.com
# For o_o spreadsheet
...
def set_spreadsheet_eBay_getPrices_2(SHEET_NAME):
...
##################################################
# For eBay_getPrices_2 spreadsheet
def sheet_write_eBay_getPrices_2(SHEET_NAME, Start_row, Start_col, End_row, End_col, update_list):
	worksheet = set_spreadsheet_eBay_getPrices_2(SHEET_NAME)
	sheet_write(SHEET_NAME, Start_row, Start_col, End_row, End_col, update_list, worksheet)
